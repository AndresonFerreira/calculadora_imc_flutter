...
class _HomeState extends State<Home> {
  ...
  void _resetFields(){
    ...
    setState(() {
      ...
      //usado para tirar as emnsagemnsd de erros ao resetar
    });
  }
  ...
  void _calculate(){
    setState(() {
      ...
      if(imc < 18.6){
        ...
        infoText = "Obsidade Grau II (${imc.toStringAsPrecision(4)})";
      } else if(imc >= 40){
        infoText = "Obsidade Grau III (${imc.toStringAsPrecision(4)})";
      }
    });
  }
